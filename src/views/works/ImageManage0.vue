<template>
    <div style="margin-top: 30px; ">
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>未审核图片管理</el-breadcrumb-item>
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <el-popover trigger="hover" placement="left">
                  <div align="center">
                    <img v-bind:src="scope.row.url" style='width: 250px; height: 250px; padding: 0px 0px; align-content: center' />
                  </div>
                  <p>{{scope.row.title}}</p>
                  <p>作者:
...
export default {
    ...
    methods:{
        handleSearch(val) {
            ...
            this.$http.get("http://localhost:8083/works/findByTitle0/" + this.currentPage + "/" + this.size+"/"+1+"?keyword="+this.search).then(res=>{
        ...
        getAllData() {
            console.log("create func");
            this.$http.get("http://localhost:8083/works/findAll0?currentPage=" + this.currentPage + "&size=" + this.size + "&categoryId=1").then(res=>{
                // this.tableData = res.data
                this.tableData = res.data.list
      ...
      handleCurrentChange(val) {
        ...
        handleCheck(option) {
          if (option === 1) {
            ...
            this.$router.push('/homeView/imageManage0');
          }
        },
