<template>
    <div style="margin-top: 30px; ">
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>已审核图片管理</el-breadcrumb-item>
...
export default {
    ...
    methods:{
        handleSearch(val) {
            ...
            this.$http.get("http://localhost:8083/works/findByTitle/" + this.currentPage + "/" + this.size+"/"+1+"?keyword="+this.search).then(res=>{
        ...
        getAllData() {
          console.log("create func");
          this.$http.get("http://localhost:8083/works/findAll?currentPage=" + this.currentPage + "&size=" + this.size + "&categoryId=1").then(res=>{
            // this.tableData = res.data
            this.tableData = res.data.list
