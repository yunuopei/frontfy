<template>
    <div style="margin-top: 30px; ">
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>已审核视频管理</el-breadcrumb-item>
...
export default {
    ...
    methods:{
        handleSearch(val) {
            ...
            this.$http.get("http://localhost:8083/works/findByTitle/" + this.currentPage + "/" + this.size+"/"+3+"?keyword="+this.search).then(res=>{
        ...
        getAllData() {
            console.log("create func");
            this.$http.get("http://localhost:8083/works/findAll?currentPage=" + this.currentPage + "&size=" + this.size + "&categoryId=3").then(res=>{
                // this.tableData = res.data
                this.tableData = res.data.list
