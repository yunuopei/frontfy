<template>
    <div style="margin-top: 30px; ">
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>未审核展馆</el-breadcrumb-item>
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    <el-popover trigger="hover" placement="left">
                        <div align="center">
                            <img v-bind:src="scope.row.url" style='width: 250px; height: 250px; padding: 0px 0px; align-content: center; z-index: 9999' ></img>
                        </div>
                        <p>{{scope.row.title}}</p>
                        <p>创办人:
                            <span  >
...
export default {
    ...
    methods:{
        handleSearch(val) {
            ...
            this.$http.get("http://localhost:8083/exhibition/searchExhibition0/" + this.currentPage + "/" + this.size+"?keyword="+this.search).then(res=>{
        ...
        getAllData() {
            console.log("create func");
            this.$http.get("http://localhost:8083/exhibition/findAllByStatus?currentPage=" + this.currentPage + "&size=" + this.size + "&status=" + -1 ).then(res=>{
