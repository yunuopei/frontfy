        ...
        <el-container>
            <el-header>
                ...
                <div style="margin-left: 40px">
                    ...
                    <!--                <img src="@/assets/R-C.jpg" alt="头像">username-->
                    <!-- <el-button type="info" icon="el-icon-s-custom" circle @click="login"></el-button> -->
                </div>
            </el-header>
            <el-main>
                <!-- 菜单按钮 -->
                <div class="navbar-menu-button" @click="showMenu = !showMenu">
                ...
                <div class="nav" :class="{ 'is-active': showMenu }">
                    ...
                    <el-dropdown >
                        ...
                        <el-dropdown-menu slot="dropdown" style="background-color: rgba(128,128,128,0.1);color: white; font-weight: bold">
                    ...
                    <el-dropdown >
                        ...
                        <el-dropdown-menu class="menu" slot="dropdown" style="background-color: rgba(128,128,128,0.1); color: white; font-weight: bold">
