            ...
            <el-form :model="ruleForm" style="margin-right: 30px;margin-top: 100px" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item label="上传头像" >
                    <el-upload
                        ...
                        :multiple="true"
                        action="http://localhost:8083/user/register"
                        :show-file-list="true"
                    ...
                    >
                        <img :src="ruleForm.pic" class="avatar">
...
export default {
    ...
    methods: {
        ...
        register(formName) {
            ...
            else if(this.message === 500)
                this.$message.error('用户名已存在,请重新填写用户名以及头像')
            else {
/*                this.$message.success('注册成功')
        ...
        handleSuccess(response, file, fileList) {
            ...
            console.log(this.message); // 输出服务器返回的数据
            console.log(file); // 输出上传的文件对象
            console.log(fileList); // 输出已上传的文件列表
        },
